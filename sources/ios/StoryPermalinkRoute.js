            ...
            queries: {
                viewer: function(global/*e*/, require/*t*/, requireDynamic/*n*/) {
                    return function(global/*e*/) {
                        ...
                        return new require/*t*/.Query("viewer", null, null, [requireDynamic/*n*/.__frag(global/*e*/)], null, "StoryPermalinkRoute_viewer")
                    }(require/*t*/)
                },
                story: function(global/*e*/, require/*t*/, requireDynamic/*n*/) {
                    return function(global/*e*/, require/*t*/) {
                        ...
                        return new requireLazy/*r*/.Query("node", [requireDynamic/*n*/.__var(global/*e*/)], [new requireLazy/*r*/.Field("id", null, null, null, null, null, {
                            generated: !0,
                            requisite: !0
                        })], [requireDynamic/*n*/.__frag(require/*t*/)], null, "StoryPermalinkRoute_story")
                    }(global/*e*/, require/*t*/)
                }
            }
        });
