__d("XMLHttpRequest",["NativeModulesDeprecated","crc32"],function (global/*e*/, require/*t*/, requireDynamic/*n*/, requireLazy/*r*/, module/*i*/) {
    ...
    o.prototype.getAllResponseHeaders = function() {
        ...
        this.$XMLHttpRequest_method = global/*e*/, this.$XMLHttpRequest_url = require/*t*/, this.$XMLHttpRequest_aborted = !1, this.$XMLHttpRequest_setReadyState(exports/*this.OPENED*/)
    }, o.prototype.send = function(global/*e*/) {
        if (this.readyState !== exports/*this.OPENED*/) throw new Error("Request has not been opened");
        ...
        console.warn("XMLHttpRequest: abort() cancels JS callbacks but not native HTTP request."), this.readyState === this.UNSENT || this.readyState === exports/*this.OPENED*/ && !this.$XMLHttpRequest_sent || this.readyState === this.DONE || (this.$XMLHttpRequest_sent = !1, this.$XMLHttpRequest_setReadyState(this.DONE)), this.readyState === this.DONE && this.$XMLHttpRequest_sendLoad(), this.readyState = this.UNSENT, this.$XMLHttpRequest_aborted = !0
