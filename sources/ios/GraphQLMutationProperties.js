__d("GraphQLMutationProperties",["GraphQLMutatorConstants","invariant","rql"],function (global/*e*/, require/*t*/, requireDynamic/*n*/, requireLazy/*r*/, module/*i*/) {
    ...
    var p = {
        getFatQueryForType: function(global/*e*/) {
            if (global/*e*/ in u || a(0, "Must have a fat query for the mutation type %s. Please see https://our.intern.facebook.com/intern/dex/graphql-mutations/mutations-in-dlite/.", global/*e*/), !(global/*e*/ in l)) {
        ...
        getRangeConfigForType: function(global/*e*/) {
            ...
            if (!require/*t*/) return {};
            for (var requireDynamic/*n*/ in require/*t*/) require/*t*/[requireDynamic/*n*/] !== o.PREPEND && require/*t*/[requireDynamic/*n*/] !== o.APPEND && a(0, "range config must map to either GraphQLMutatorConstants.APPEND/PREPEND");
            return require/*t*/
        },
        ...
        setTemporaryFatQueryFactoryForType: function(global/*e*/, require/*t*/) {
            (u[global/*e*/] || l[global/*e*/]) && a(0, "Cannot set temporary fat query for mutation type %s which already has a fat query.", global/*e*/), u[global/*e*/] = require/*t*/
        },
        setTemporaryRangeConfigForType: function(global/*e*/, require/*t*/) {
            c[global/*e*/] && a(0, "Cannot set temporary range config for mutation type %s which already has a range config.", global/*e*/);
            for (var requireDynamic/*n*/ in require/*t*/) require/*t*/[requireDynamic/*n*/] !== o.PREPEND && require/*t*/[requireDynamic/*n*/] !== o.APPEND && a(0, "range config must map to either GraphQLMutatorConstants.APPEND/PREPEND");
