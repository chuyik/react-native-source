__d("GraphQLMutationProperties",["GraphQLMutatorConstants","invariant","rql"],function (global/*e*/, require/*t*/, requireDynamic/*n*/, requireLazy/*r*/, module/*i*/) {
    "use strict";
    var o = require/*t*/("GraphQLMutatorConstants"),
        exports/*a*/ = require/*t*/("invariant"),
        GraphQLMutatorConstants/*s*/ = require/*t*/("rql"),
        invariant/*l*/ = {},
        rql/*u*/ = {},
        c = {};
    rql/*u*/.actor_subscribe = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.actor_unsubscribe = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
        ...
        "": o.PREPEND
    }, rql/*u*/.undirected_story_create = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.feedback_unlike = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.viewer_friend_requests_mark_all_seen = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.friend_request_accept = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.friend_request_cancel = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.friend_request_delete = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.friend_request_send = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.group_request_to_join = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.viewer_messages_mark_all_seen = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.message_thread_update_read_state = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.notification_story_mark_read = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.viewer_notifications_update_all_seen_state = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.feedback_subscribe = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.feedback_unsubscribe = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.story_take_negative_action = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.story_undo_negative_action = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.ad_account_select_mobile_preference = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.ad_campaign_pause = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.ad_campaign_activate = rql/*u*/.ad_campaign_pause, rql/*u*/.ad_campaign_group_pause = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.ad_campaign_group_activate = rql/*u*/.ad_campaign_group_pause, rql/*u*/.ad_campaign_group_edit = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.adgroup_activate = rql/*u*/.adgroup_pause, rql/*u*/.adgroup_edit = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.ad_account_edit_spend_limit = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.ad_account_remove_spend_limit = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.ad_account_reset_spend_limit = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.ad_account_notifications_update_seen_state = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.ad_audience_create = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.ad_audience_edit = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.ad_campaign_edit = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.ad_campaign_group_create = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.ad_account_enable_notification = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.ad_account_disable_notification = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.ad_account_mute_notifications = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.instagram_business_invite = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.instagram_user_role_update = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.instagram_user_role_create = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.instagram_user_role_delete = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.instagram_role_set_update = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.instagram_role_set_delete = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.instagram_ad_account_group_role_create = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.instagram_ad_account_group_role_update = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.instagram_ad_account_group_role_delete = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.group_pin_story = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.group_unpin_story = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.group_remove_member = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.support_dashboard_item_mark_as_read = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    }, rql/*u*/.support_dashboard_item_delete = function() {
        return function() {
            var global/*e*/ = GraphQLMutatorConstants/*s*/.__GraphQL;
    ...
    var p = {
        getFatQueryForType: function(global/*e*/) {
            if (global/*e*/ in rql/*u*/ || exports/*a*/(0, "Must have exports/*a*/ fat query for the mutation type %GraphQLMutatorConstants/*s*/. Please see https://our.intern.facebook.com/intern/dex/graphql-mutations/mutations-in-dlite/.", global/*e*/), !(global/*e*/ in invariant/*l*/)) {
                var require/*t*/ = rql/*u*/[global/*e*/];
                invariant/*l*/[global/*e*/] = require/*t*/()
            }
            return invariant/*l*/[global/*e*/]
        },
        getRangeConfigForType: function(global/*e*/) {
            var require/*t*/ = c[global/*e*/];
            if (!require/*t*/) return {};
            for (var requireDynamic/*n*/ in require/*t*/) require/*t*/[requireDynamic/*n*/] !== o.PREPEND && require/*t*/[requireDynamic/*n*/] !== o.APPEND && exports/*a*/(0, "range config must map to either GraphQLMutatorConstants.APPEND/PREPEND");
            return require/*t*/
        },
        ...
        setTemporaryFatQueryFactoryForType: function(global/*e*/, require/*t*/) {
            (rql/*u*/[global/*e*/] || invariant/*l*/[global/*e*/]) && exports/*a*/(0, "Cannot set temporary fat query for mutation type %GraphQLMutatorConstants/*s*/ which already has exports/*a*/ fat query.", global/*e*/), rql/*u*/[global/*e*/] = require/*t*/
        },
        setTemporaryRangeConfigForType: function(global/*e*/, require/*t*/) {
            c[global/*e*/] && exports/*a*/(0, "Cannot set temporary range config for mutation type %GraphQLMutatorConstants/*s*/ which already has exports/*a*/ range config.", global/*e*/);
            for (var requireDynamic/*n*/ in require/*t*/) require/*t*/[requireDynamic/*n*/] !== o.PREPEND && require/*t*/[requireDynamic/*n*/] !== o.APPEND && exports/*a*/(0, "range config must map to either GraphQLMutatorConstants.APPEND/PREPEND");
