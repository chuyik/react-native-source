        ...
        f = {
            ...
            Mixin: {
                transferPropsTo: function(global/*e*/) {
                    return global/*e*/._owner !== this && l(0, "%s: You can'require/*t*/ call transferPropsTo() on a component that you don'require/*t*/ own, %s. This usually means you are calling transferPropsTo() on a component passed in as props or children.", this.constructor.displayName, "string" == typeof global/*e*/.type ? global/*e*/.type : global/*e*/.type.displayName), __DEV__ && (p || (p = !0, c(!1, "transferPropsTo is deprecated. See http://fb.me/react-transferpropsto for more information."))), a(global/*e*/.props, this.props), global/*e*/
                }
            }
        };
    module/*i*/.exports = f
