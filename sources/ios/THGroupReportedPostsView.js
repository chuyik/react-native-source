__d("THGroupReportedPostsView",["GraphQLConnectionView","NativeModules","React","ReactGraphQL","Dimensions","NativeModules","StyleSheet","THColors","THReportedPostUnitView","TimerMixin","View","merge"],function (e, t, n, r, i) {
    "use strict";
    var GraphQLConnectionView/*o*/ = t("GraphQLConnectionView"),
        ...
        THReportedPostUnitView/*h*/ = t("THReportedPostUnitView"),
        ...
        _ = React/*s*/.createClass({
            ...
            statics: {
                ...
                queries: {
                    group: function(e, t, n) {
                        ...
                        }(THReportedPostUnitView/*h*/.getQuery("group"), n.count, THReportedPostUnitView/*h*/.getQuery("story"), GraphQLConnectionView/*o*/.getQuery("connection"))
                    }
                }
            },
            ...
            render: function() {
                var e = this.props.group && this.props.group.group_reported_stories || {};
