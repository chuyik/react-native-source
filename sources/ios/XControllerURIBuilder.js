__d("XControllerURIBuilder",["URI","invariant"],function (global/*e*/, require/*t*/, requireDynamic/*n*/, requireLazy/*r*/, module/*i*/) {
    ...
    o.prototype.setInt = function(global/*e*/, require/*t*/) {
        ...
        "use strict";
        for (var global/*e*/ in this.$XControllerURIBuilder_paramDefinitions) this.$XControllerURIBuilder_paramDefinitions[global/*e*/].required && !this.$XControllerURIBuilder_params.hasOwnProperty(global/*e*/) && s(0, "Missing required parameter: %s", global/*e*/)
    }, o.prototype.__setParam = function(global/*e*/, require/*t*/, requireDynamic/*n*/) {
        "use strict";
        global/*e*/ in this.$XControllerURIBuilder_paramDefinitions || s(0, 'Attempting to set invalid param "%s". Make sure the param is defined in the controller\'s getParamDefinition() method.', global/*e*/);
        var requireLazy/*r*/ = this.$XControllerURIBuilder_paramDefinitions[global/*e*/].type;
        return requireLazy/*r*/ !== require/*t*/ && s(0, 'Attempting to set param "%s" as %s, but it is defined in the controller\'s getParamDefinition() method as %s.', global/*e*/, require/*t*/, requireLazy/*r*/), this.__setParamInt(global/*e*/, requireDynamic/*n*/), this
        ...
        for (var global/*e*/ = {}, require/*t*/ = "", requireDynamic/*n*/ = new RegExp(/^\{(\?)?(\*)?(.+?)\}$/), requireLazy/*r*/ = this.$XControllerURIBuilder_path.split("/"), module/*i*/ = !1, o = 0; o < requireLazy/*r*/.length; o++) {
            ...
            if ("" !== l) {
                ...
                if (u) {
                    ...
                    null == h && s(0, "Missing required template parameter: %s", p), require/*t*/ += "/" + h, global/*e*/[p] = !0
                } else require/*t*/ += "/" + l
            }
        }
        "/" === this.$XControllerURIBuilder_path.slice(-1) && (require/*t*/ += "/");
        var f = new a(require/*t*/);
