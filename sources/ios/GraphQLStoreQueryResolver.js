__d("GraphQLStoreQueryResolver",["DliteProfiler","GraphQLStore","GraphQLStoreChangeEmitter","GraphQLStoreDataHandler","GraphQLStoreRangeUtils","forEachObject","invariant"],function (global/*e*/, require/*t*/, requireDynamic/*n*/, requireLazy/*r*/, module/*i*/) {
    ...
    function l(global/*e*/, require/*t*/, requireDynamic/*n*/) {
        var requireLazy/*r*/, module/*i*/ = GraphQLStore/*d*/.getDeepNodeFromData(global/*e*/, require/*t*/, function(require/*t*/) {
    ...
    function u(global/*e*/) {
        ...
        for (var requireDynamic/*n*/ = {}, requireLazy/*r*/ = [global/*e*/]; requireLazy/*r*/.length;) {
            ...
            if (module/*i*/ && "object" == typeof module/*i*/) {
                var o = GraphQLStoreDataHandler/*f*/.getID(module/*i*/);
                null != o && (requireDynamic/*n*/[o] = null), forEachObject/*g*/(module/*i*/, require/*t*/)
            }
        }
    ...
    function c(global/*e*/) {
        var require/*t*/ = GraphQLStoreRangeUtils/*m*/.parseRangeClientID(global/*e*/);
        return require/*t*/ ? require/*t*/.dataID : global/*e*/
    }
    var DliteProfiler/*p*/ = require/*t*/("DliteProfiler"),
        GraphQLStore/*d*/ = require/*t*/("GraphQLStore"),
        GraphQLStoreChangeEmitter/*h*/ = require/*t*/("GraphQLStoreChangeEmitter"),
        GraphQLStoreDataHandler/*f*/ = require/*t*/("GraphQLStoreDataHandler"),
        GraphQLStoreRangeUtils/*m*/ = require/*t*/("GraphQLStoreRangeUtils"),
        forEachObject/*g*/ = require/*t*/("forEachObject"),
    ...
    o.prototype.reset = function() {
        ...
        null == require/*t*/ || Array.isArray(require/*t*/) || invariant/*_*/(0, "GraphQLStoreQueryResolver: Plural fragment can only resolve an array of pointers.");
        ...
        Array.isArray(require/*t*/) && invariant/*_*/(0, "GraphQLStoreQueryResolver: Singular fragment cannot resolve an array of pointers.");
        ...
        if (require/*t*/) {
            if (requireLazy/*r*/ = GraphQLStoreDataHandler/*f*/.getID(require/*t*/), null != o && null != requireLazy/*r*/ && c(o) === c(requireLazy/*r*/))
