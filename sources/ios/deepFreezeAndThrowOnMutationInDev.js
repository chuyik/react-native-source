__d("deepFreezeAndThrowOnMutationInDev",[],function (global/*e*/, require/*t*/, requireDynamic/*n*/, requireLazy/*r*/, module/*i*/) {
    function o(global/*e*/) {
        if (__DEV__) {
            ...
            for (var require/*t*/ in global/*e*/) global/*e*/.hasOwnProperty(require/*t*/) && (global/*e*/.__defineGetter__(require/*t*/, exports/*s.bind*/(null, global/*e*/[require/*t*/])), global/*e*/.__defineSetter__(require/*t*/, a.bind(null, require/*t*/)), o(global/*e*/[require/*t*/]));
